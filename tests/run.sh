...
echo "== sug-xls (regresión v6.66: el Excel sugerido vuelve a entrar por el importador de la PPP) =="
PLAYWRIGHT_BROWSERS_PATH="${PLAYWRIGHT_BROWSERS_PATH:-/opt/pw-browsers}" node tests/sug-xls.cjs
