...
// ============================================================
// ESTADÍSTICA MADRE — IMPORTADOR: RETIRADO el 2026-09-02 (propuesta 2496).
// `estadistica_madre` ya no es una tabla que se llena desde un Excel: es una VISTA
// sobre `estadistica_madre_cache` (calculada a diario desde sales_lines). Los
// lectores de esta página (loadEstadisticaMadre) no cambiaron: la vista expone las
// mismas columnas. El Excel histórico quedó en `estadistica_madre_import_20260506`.
// ============================================================
