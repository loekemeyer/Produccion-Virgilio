...
>
> Nota **2026-09-03 — v12.69: fix bordes del encabezado (Excel descartaba estilos porque cellXfs/borders índice 0 no era el Normal por defecto; ahora sí) + tamaños de fuente 16 (encabezado, negrita) y 14 (datos). v12.68: auto-ajuste de ancho (solo si hace falta) en Proy. caj/mes, Total Stock y Cajas Pedidas: si la cifra más larga no entra en el ancho fijo, se ensancha a lo justo (piso = ancho fijo). v12.67: encabezado del Excel de Stocks en NEGRITA (fontId 1). v12.66: formato (bordes + alineación + ajustar texto).**
